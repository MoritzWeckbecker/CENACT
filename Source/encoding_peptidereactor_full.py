...
def encode_all_datasets():
    datasets_path = os.path.join('.', 'CMANGOES-2.0', 'Data_peptidereactor_full', 'Original_datasets')
    ...
    datasets_list = [data for data in datasets_list if data not in datasets_in_cmangoes]

    encodings_path = os.path.join('.', 'CMANGOES-2.0', 'Data_peptidereactor_full', 'Encodings')
